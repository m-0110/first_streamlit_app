...
fruit_choice = streamlit.text_input("What fruit would you like information about?","Kiwi")#"Kiwi default input
...
my_cur.execute("insert into fruit_load_list values('{}')".format(fruit_choice1))
